# Parivahan Renewal — Design Contract
...
Help a citizen understand and complete a synthetic driving-licence renewal without making them navigate a directory of government portals.

**Visual thesis:** a calm civic help desk for one important task. The experience should feel reassuring, precise, and contemporary—not institutional, promotional, or decorative.

**Content plan:** public explanation → secure sign-in → licence overview → guided renewal → review → mock payment → receipt and trackable status. Each screen answers three questions: where am I, what is needed now, and what happens next?
...
Show “Hackathon prototype—not an official government service” in the persistent header or immediately below it. Never use a government emblem or imply endorsement. Never send requests to Parivahan, Sarathi, Vahan, eChallan, PUCC, or any government system.
...
Use a compact civic header and an asymmetric editorial hero. Lead with “Renew your licence with clarity” and a short, concrete promise. Place the primary “Try the renewal demo” action beside a secondary “How this prototype works” link. On wide screens, pair the copy with a single purpose-built renewal progress composition—not a card grid or stock photograph.

Below the fold, show the current friction, the improved five-step path, and a concise mock-data disclosure. Prefer connected sections, timelines, and lists to repeated floating cards.
...
No government emblem, campaign carousel, full-screen popup, tricolour gradient, generic card wall, hidden requirements, admin panel, decorative 3D, dark theme, glossy gradients, glassmorphism, or live government integration.
