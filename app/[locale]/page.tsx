            ...
            <section id="find-service" className="scroll-mt-24 py-16 sm:py-20 lg:grid lg:min-h-[680px] lg:grid-cols-[minmax(0,1fr)_390px] lg:items-center lg:gap-10 lg:py-12">
              <div className="min-w-0">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Button asChild variant="secondary" size="lg"><Link href={localPath(locale, '/readiness')}>{locale === 'hi' ? 'Raahi से पूछें' : 'Ask Raahi'}<ArrowRight data-icon="inline-end" /></Link></Button>
                </div>
